...
else
{
	...
	else
	{
		...
		{
			$sql = "SELECT 	user_id,user_name,user_level  FROM	$userstable WHERE user_name = '" . mysql_real_escape_string($_POST['user_name']) . "' 	AND user_pass = '" . sha1($_POST['user_pass']) . "' AND user_level=9";
					...
					while($row = mysql_fetch_assoc($result))
					{
						if($row['user_level']=="2") 
						{
							...
							$_SESSION['user_level'] = $row['user_level'];
								...
								<br><br><br><a href="admin.php" class="button2">Proceed to the Main Page</a><br><br>
							</div>
			<div id="footer"><br><br>
