...
if($_SERVER['REQUEST_METHOD'] != 'POST')
{
	echo '<center>
		<div id="header">
		<br><span class="button1">Class Scheduler</span><br>
		</div>
		<div id="data">
...
echo '	</div></div>
	<div id="footer">
	 <a style="float:left;" href="signup.php" class="button2">Create User Account<a>
	 <a style="float:right;" href="signin.php" class="button2">Log In</a>
	</div>
 ';
 ?>