...
<div id="footer">
<a style="float:left;" href="login.php" class="button2"> Login<a>
...
<a style="float:right;" href="forgot.php" class="button2">Forgot Password?</a></div></center>';
	...
	else
	{
		...
		$sql = "INSERT INTO  $userstable(user_name, user_pass, user_email ,user_date,user_level)
			VALUES('" . mysql_real_escape_string($_POST['user_name']) . "','" . sha1($_POST['user_pass']) . "', '" . mysql_real_escape_string($_POST['user_email']) . "',NOW(),9)";
		$result = mysql_query($sql);
		...
		elseif(!$result)
		{
			...
			//   $from = $company_email_address;
			   ...
			   $subject = 'Welcome to Class Scheduler';
...
Thank you for registrering to as manager.<br>
...
EOF;
		...
		echo '<center>		
			...
			<div id="footer"><br><a href="login.php" class="button2"> Login Now<a></div></center>';
		}
	}
