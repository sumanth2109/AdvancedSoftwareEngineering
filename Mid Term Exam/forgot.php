...
if($_SERVER['REQUEST_METHOD'] != 'POST')
{
	echo '<center>
		<div id="header">
		<span class="button1">Route Finder<img src="images/logo.png" width="50" height="50" style="border:0px;"/></span><br>
		</div>
		<div id="data">
...
else
{
	...
	if(mysql_num_rows($result) == 0)
	{
		echo '<center>
		<div id="header">
		<span class="button1">Route Finder<img src="images/logo.png" width="50" height="50" style="border:0px;"/></span><br><br>
		</div>
		<div id="data">
